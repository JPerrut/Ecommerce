...
export default function ProdutoItem(props: ProdutoItemProps) {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex flex-col gap-3 p-5 border-t border-white/10 justify-between">
                <div className="self-start text-sm border-b border-dashed flex flex-col gap-1">
